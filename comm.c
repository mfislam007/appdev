...
//this function will calculate 1 second of sound samples into 8-pices of
//slow decibel (ISO standard), this data is calculated as 125ms of samples
// the first jalf of function is to calculate, the second half is to pwerform
...
void sendDATA(short s[])
{
	...
	// use libcurl functions to send data
	CURL *c;
	CURLcode res;
	char poststr[128];
